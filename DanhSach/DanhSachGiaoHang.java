...
public class DanhSachGiaoHang {
    ...
    public GiaoHang timKiemGiaoHangTheoMaDGH(String maDonGH) {
        for (GiaoHang GiaoHang : DS_GiaoHang) {
    ...
    public void timKiemGiaoHangTheoMaDGH() {
    ...
    public void timKiemGiaoHangTheoMaDH() {
...
//                System.out.print("Mã đơn hàng không tồn tại trong danh sách đơn hàng, vui lòng nhập lại: ");
//            } else {
//                break;
//            }
//        }
...
//                        }
    ...
    public void ghiFile() {
        ...
        try {
            ...
            for (GiaoHang GiaoHang : DS_GiaoHang) {
                bw.write(GiaoHang.getMaGiaoHang() + "#" + GiaoHang.getMaDH() + "#" + KiemTra.chuyenDateThanhChuoi(GiaoHang.getNgayGiaoHang()) + "#" + GiaoHang.getDiaChiGiaoHang() + "#" + GiaoHang.getPhiGiaoHang() + "#" + GiaoHang.getPhuongThucGiaoHang());
                bw.newLine();
            }
