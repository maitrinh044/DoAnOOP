...
public class DanhSachKhachHang implements File {
    ...
    // 6. Phương thức xóa một khách hàng khỏi danh sách dựa vào mã số KH do người
    // dùng nhập vào
    ...
    public void ghiFile() {
        ...
        try {
            FileWriter fw = new FileWriter("input/KhuyenMai.txt");
            BufferedWriter bw = new BufferedWriter(fw);

            for (KhachHang khachHang : DS_KhachHang) {
                bw.write(khachHang.getMaKH() + "#" + khachHang.getTenKH() + "#" + khachHang.getDiaChi() + "#"
